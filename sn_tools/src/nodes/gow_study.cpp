...
*/
  ...
  std::string filename = "/home/duceux/Desktop/results/gow_study/score.txt";
  std::ofstream file(filename, std::ofstream::app);
  std::string folder = "/home/duceux/Desktop/results/gow_study/";
...

  {
    ...
    sn::print(matrix);
    file << "bow\t" << sn::get_precision(matrix) << "\t"
         << sn::get_precision_ignoring_missed(matrix) << std::endl;
    sn::save_confusion_matrix(matrix, folder+"bow.txt");
  }
  {
    ...
    std::cout << sn::get_precision(matrix) << std::endl;
    sn::print(matrix);
    file << "gow\t" << sn::get_precision(matrix) << "\t"
         << sn::get_precision_ignoring_missed(matrix)<< std::endl;
    sn::save_confusion_matrix(matrix, folder+"gow.txt");
  }
  {
    std::cout << "NodeIntersection\n";
    auto gfunc = sn::comparison::node_intersection(sn::no_type());
    auto matrix = sn::confusion_matrix(gtruth, gtest, gfunc);
    std::cout << sn::get_precision(matrix) << std::endl;
    sn::print(matrix);
    file << "node\t" << sn::get_precision(matrix)<< "\t"
         << sn::get_precision_ignoring_missed(matrix) << std::endl;
    sn::save_confusion_matrix(matrix, folder+"node.txt");
  }
  {
    std::cout << "EdgeIntersection\n";
    auto gfunc = sn::comparison::edge_intersection(sn::no_type());
    auto matrix = sn::confusion_matrix(gtruth, gtest, gfunc);
    std::cout << sn::get_precision(matrix) << std::endl;
    sn::print(matrix);
    file << "edge\t" << sn::get_precision(matrix) << "\t"
         << sn::get_precision_ignoring_missed(matrix)<< std::endl;
    sn::save_confusion_matrix(matrix, folder+"edge.txt");
  }
  {

    std::cout << "LaserIntersection\n";
    auto gfunc = sn::comparison::intersection_size(sn::single_type("laser", true));
    auto matrix = sn::confusion_matrix(gtruth, gtest, gfunc);
    std::cout << sn::get_precision(matrix) << std::endl;
    sn::print(matrix);
    file << "laser\t" << sn::get_precision(matrix) << "\t"
         << sn::get_precision_ignoring_missed(matrix)<< std::endl;
    sn::save_confusion_matrix(matrix, folder+"laser.txt");
  }
  {
    std::cout << "PfhIntersection\n";
    auto gfunc = sn::comparison::intersection_size(sn::single_type("pfh", true));
    auto matrix = sn::confusion_matrix(gtruth, gtest, gfunc);
    std::cout << sn::get_precision(matrix) << std::endl;
    sn::print(matrix);
    file << "pfh\t" << sn::get_precision(matrix) << "\t"
         << sn::get_precision_ignoring_missed(matrix)<< std::endl;
    sn::save_confusion_matrix(matrix, folder+"pfh.txt");
  }
  {
    std::cout << "TbgrIntersection\n";
    auto gfunc = sn::comparison::intersection_size(sn::single_type("tbgr", true));
    auto matrix = sn::confusion_matrix(gtruth, gtest, gfunc);
    std::cout << sn::get_precision(matrix) << std::endl;
    sn::print(matrix);
    file << "tbgr\t" << sn::get_precision(matrix) << "\t"
         << sn::get_precision_ignoring_missed(matrix)<< std::endl;
    sn::save_confusion_matrix(matrix, folder+"tbgr.txt");
  }
  {
    std::cout << "SizeIntersection\n";
    auto gfunc = sn::comparison::intersection_size(sn::single_type("size", true));
    auto matrix = sn::confusion_matrix(gtruth, gtest, gfunc);
    std::cout << sn::get_precision(matrix) << std::endl;
    sn::print(matrix);
    file << "size\t" << sn::get_precision(matrix) << "\t"
         << sn::get_precision_ignoring_missed(matrix)<< std::endl;
    sn::save_confusion_matrix(matrix, folder+"size.txt");
  }
  {
    std::cout << "ColorIntersection\n";
    auto gfunc = sn::comparison::intersection_size(sn::single_type("color", true));
    auto matrix = sn::confusion_matrix(gtruth, gtest, gfunc);
    std::cout << sn::get_precision(matrix) << std::endl;
    sn::print(matrix);
    file << "color\t" << sn::get_precision(matrix)<< "\t"
         << sn::get_precision_ignoring_missed(matrix) << std::endl;
    sn::save_confusion_matrix(matrix, folder+"color.txt");
  }
  {
    std::cout << "Without LaserIntersection\n";
    auto gfunc = sn::comparison::intersection_size(sn::single_type("laser", false));
    auto matrix = sn::confusion_matrix(gtruth, gtest, gfunc);
    std::cout << sn::get_precision(matrix) << std::endl;
    sn::print(matrix);
    file << "wihtout laser\t" << sn::get_precision(matrix) << "\t"
         << sn::get_precision_ignoring_missed(matrix)<< std::endl;
    sn::save_confusion_matrix(matrix, folder+"without_laser.txt");
  }
  {
    std::cout << "Without PfhIntersection\n";
    auto gfunc = sn::comparison::intersection_size(sn::single_type("pfh", false));
    auto matrix = sn::confusion_matrix(gtruth, gtest, gfunc);
    std::cout << sn::get_precision(matrix) << std::endl;
    sn::print(matrix);
    file << "wihtout pfh\t" << sn::get_precision(matrix) << "\t"
         << sn::get_precision_ignoring_missed(matrix)<< std::endl;
    sn::save_confusion_matrix(matrix, folder+"without_pfh.txt");
  }
  {
    std::cout << "Without TbgrIntersection\n";
    auto gfunc = sn::comparison::intersection_size(sn::single_type("tbgr", false));
    auto matrix = sn::confusion_matrix(gtruth, gtest, gfunc);
    std::cout << sn::get_precision(matrix) << std::endl;
    sn::print(matrix);
    file << "wihtout tbgr\t" << sn::get_precision(matrix) << "\t"
         << sn::get_precision_ignoring_missed(matrix)<< std::endl;
    sn::save_confusion_matrix(matrix, folder+"without_tbgr.txt");
  }
  {
    std::cout << "Without SizeIntersection\n";
    auto gfunc = sn::comparison::intersection_size(sn::single_type("size", false));
    auto matrix = sn::confusion_matrix(gtruth, gtest, gfunc);
    std::cout << sn::get_precision(matrix) << std::endl;
    sn::print(matrix);
    file << "wihtout size\t" << sn::get_precision(matrix) << "\t"
         << sn::get_precision_ignoring_missed(matrix)<< std::endl;
    sn::save_confusion_matrix(matrix, folder+"without_size.txt");
  }
  {
    std::cout << "Without ColorIntersection\n";
    auto gfunc = sn::comparison::intersection_size(sn::single_type("color", false));
    auto matrix = sn::confusion_matrix(gtruth, gtest, gfunc);
    std::cout << sn::get_precision(matrix) << std::endl;
    sn::print(matrix);
    file << "wihtout color\t" << sn::get_precision(matrix)<< "\t"
         << sn::get_precision_ignoring_missed(matrix) << std::endl;
    sn::save_confusion_matrix(matrix, folder+"without_color.txt");
  }
